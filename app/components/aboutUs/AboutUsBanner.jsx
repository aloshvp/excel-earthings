...
import { timeline, animate, inView } from "@motionone/dom";
...
const AboutUsBanner = () => {
    ...
    useEffect(() => {
        ...
        // LEFT CONTENT FADE-UP (NO DELAY)
        animate(
            ".aboutUsBannerContentLft",
            { opacity: [0, 1], transform: ["translateY(15px)", "translateY(0px)"] },
            // { duration: 0.28, easing: "cubic-bezier(0.25, 0.46, 0.45, 1)" }
            { duration: 0.28, easing: "ease-out" }
        );

        // RIGHT SIDE GRID ITEMS FADE-UP (WITH STAGGER)
